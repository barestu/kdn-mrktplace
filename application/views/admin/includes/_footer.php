...
<footer class="main-footer">
    <div class="pull-right hidden-xs">
        <b style="font-weight: 600;">Version</b> 1.9.1
    </div>
...
<!-- Plugins JS-->
<script src="<?php echo base_url(); ?>assets/admin/js/plugins-1.9.js"></script>

<script src="<?php echo base_url(); ?>assets/admin/vendor/magnific-popup/jquery.magnific-popup.min.js"></script>
<!-- Custom js -->
<script src="<?php echo base_url(); ?>assets/admin/js/main-1.9.js"></script>
<!--tinyMCE-->
